...
import { album } from './core/album.js';
import { artist } from './core/artist.js';
import { music, musicSync } from './core/music.js';
import { video, videoSync } from './core/video.js';
import { Cookies } from './helper/cookies.js';
import { Lapse } from './helper/lapse.js';
import { appendURL, getIDFromURL, isURL, validateOptions } from './util.js';
class Client {
    ...
    jar;
    constructor(options) {
        const mergedOptions = validateOptions(options);
        ...
        this.instance.interceptors.request.use(options => {
            const requestURL = appendURL(options.url, options.baseURL).toString();
    ...
    setOptions(options) {
        ...
        const confirmedOptions = validateOptions(mergedOptions);
    ...
    album(idOrURL) {
        ...
        const id = isURL(value) ? getIDFromURL(value) : value;
        return album({
            id,
